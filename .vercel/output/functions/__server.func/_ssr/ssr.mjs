...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BbURXgbc.mjs");
...
var manifest = {
	"0119e7b459378f03c87fe68e59c4e025e19617e7f2fc8005fabfca41f8d9155c": {
		functionName: "coachEditPrompt_createServerFn_handler",
		importer: () => import("./server-CJCF48Lt.mjs")
	},
	"9eeb551c4573b1a55ef17ded37f00c9fd08cb9cfd428a058036a03ad77fca998": {
		functionName: "ingestUpload_createServerFn_handler",
		importer: () => import("./server-CJCF48Lt.mjs")
	},
	"c7492c6567c74cfe3cf49d6289d39be26a0ff063189f490557337f1803e7ddc9": {
		functionName: "editPlaceImage_createServerFn_handler",
		importer: () => import("./server-CJCF48Lt.mjs")
	},
	"d06e8dd94c358042bc248155b950062ba94130ef2884d17c612edcffb1232f96": {
		functionName: "grokStatus_createServerFn_handler",
		importer: () => import("./server-CJCF48Lt.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-BqzKM1KQ.mjs").then((n) => n.t),
